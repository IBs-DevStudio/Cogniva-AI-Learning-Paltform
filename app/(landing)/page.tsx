      ...
      <div className="relative z-10">
            ...
            <div className={`transform transition-all duration-1000 delay-200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="bg-white/90 backdrop-blur-sm rounded-4xl p-6 border border-primary/20 shadow-lg max-w-4xl mx-auto mb-8">
                <p className="text-lg text-foreground leading-relaxed">
                  ...
                  Built by <span className="font-semibold text-cta">IB's Dev World</span>, a development studio that turns complex ideas into simple, user-friendly apps.
                </p>
              </div>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-cta/5 to-primary/5">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-foreground mb-6">
                About IB's Dev World
              </h2>
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                IBS's Dev World creates cutting-edge digital solutions as part of their innovative project series. 
                I transform complex ideas into user-friendly applications that solve real-world problems.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  At IB's Dev World, we believe that the most powerful solutions are often the simplest ones. 
              ...
              <div className="bg-white rounded-4xl p-8 border border-border shadow-lg">
                <div className="text-center space-y-4">
                  ...
                  <h4 className="text-2xl font-bold text-foreground">IB's Mission</h4>
                  <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex items-center justify-between max-sm:flex-col max-sm:gap-6">
              ...
              <div className="text-center max-sm:text-left">
                <p className="text-muted-foreground text-lg mb-2">
                  Built with ❤️ by <span className="text-primary font-semibold">IB's Dev World</span>
                </p>
